...
State getState(Mat img_ori, Mat img_p, Mat img_m, double deltaZ_p, double deltaZ_m, double pixel_size, double scale,int * flag)
{
	...
	int Laplace_Flag_p;
	int Laplace_Flag_m;
	HV_Lap hv_lap_o = getEdgeLaplace(img_ori, block_size, thr, edge_size,  f, scale, pixel_size, d_obj, size, block,&Laplace_Flag_o);
	HV_Lap hv_lap_p = getEdgeLaplace(img_p, block_size, thr, edge_size,  f, scale, pixel_size, d_obj, size, block,&Laplace_Flag_p);
	HV_Lap hv_lap_m = getEdgeLaplace(img_m, block_size, thr, edge_size,  f, scale, pixel_size, d_obj, size, block,&Laplace_Flag_m);
	...
	vector<double> y_lap_o = hv_lap_o.vertical_lap;//垂直拉普拉斯
